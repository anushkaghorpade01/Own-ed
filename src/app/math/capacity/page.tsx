...
export default function CapacityPage() {
  ...
  return (
    <div>
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-sm">Key distinctions</CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <CardContent className="space-y-4">
              ...
              <tbody>
                {[
                  ...
                  <tr key={String(label)} className="border-b border-[#FAF8F5]">
                    <td className="py-2 pr-4 text-[#6B6560]">{String(label)}</td>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg bg-[#FAF8F5] p-4">
              <p className="text-xs text-[#A39E98]">Eligible coverage ratio</p>
            ...
            <div className="rounded-lg bg-[#FAF8F5] p-4">
              <p className="text-xs text-[#A39E98]">Peak-time eligible coverage</p>
            ...
            <div className="rounded-lg bg-[#FAF8F5] p-4 opacity-60">
              <p className="text-xs text-[#A39E98]">Naive total capacity ratio (misleading)</p>
